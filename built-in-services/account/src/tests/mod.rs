...
use crate::types::{GenerateAccountPayload,GenerateAccountResponse, PayloadAccount, GetAccountPayload, Account};
...
fn test_generate(){
    ...
    let res_get = service.get_account_from_address( context,GetAccountPayload{
        user:addr,
    });
